...
export const ALERT_METRICS: AlertMetricOption[] = [
  ...
  // --- Baseline móvel e anomalias estatísticas (§2.3.3) --------------------
  {
    ...
    hint: 'Média histórica de latência dos últimos 7 dias. Útil para regras informativas de referência.',
    kind: 'number',
    unit: 'ms',
    defaultOperator: 'gt',
    defaultValue: 200,
  ...
  },
  {
    ...
    title: 'Desvio de latência acima da baseline (%)',
    hint: 'Quanto a latência atual está acima da média histórica. Ex.: 50 significa 50% acima.',
    kind: 'number',
    unit: '%',
    defaultOperator: 'gt',
    defaultValue: 50,
  ...
  },
  {
    ...
    title: 'Desvio de perda de pacotes acima da baseline (p.p.)',
    hint: 'Diferença absoluta da perda atual em relação à baseline, em pontos percentuais.',
    kind: 'number',
    unit: 'p.p.',
    defaultOperator: 'gt',
    defaultValue: 10,
