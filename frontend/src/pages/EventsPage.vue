  ...
  <div>
    <div class="d-flex align-center justify-space-between mb-6">
      <div>
        ...
        <p class="text-subtitle-1 text-grey-darken-1">Fluxo contínuo de eventos transmitidos via Server-Sent Events (SSE)</p>
      </div>
      ...
      <v-card-text class="pa-0">
        <v-list lines="two">
          ...
          >
            ...
            <v-list-item-subtitle class="font-mono">{{ JSON.stringify(evt.data) }}</v-list-item-subtitle>
            <template #append>
